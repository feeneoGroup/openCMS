...
<script language="c#" runat="server">
  ...
  string Form_Table,Field_title,Field_name,Field_type,Value_type,Defaultvalue,Fitems,Submit_Js,Style,Fck_Style,Mustfill,MustFillName,MustFillField,MustFillType,Input_Attribute,DateInput;
       ...
       switch(Field_type)
        {
          ...
          FormHtml+="\r\n<tr><td align=right>"+Field_title+Mustfill+"</td><td><input type=text name=\""+Field_name+"\" id=\""+Field_name+"\" value=\""+Defaultvalue+"\"" +Style+Input_Attribute+">"+DateInput+"</td></tr>";
          break;
