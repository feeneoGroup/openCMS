...
<tr>
  <td align="left"></td>
 <td align="left"><input type="button" value="发送测试邮件" onclick="SendTest('email')" class="bt"></td>
</td>
</tr>
</table>
</div>
...
<tr>
  <td align="left"></td>
 <td align="left"><input type="button" value="查看账户信息" onclick="SmsInfo()" class="bt"> &nbsp;  <input type="button" value="发送测试短信" onclick="SendTest('sms')" class="bt">
</td>
</td>
</tr>
</table>
