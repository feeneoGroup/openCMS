...
<tr>
  ...
  <td><asp:TextBox id="Zdy_image" runat="server"  TextMode="multiLine"  style="width:95%;height:100px"/><br>多个图片请用"|"分开,
 <asp:RequiredFieldValidator   ControlToValidate="zdy_image" display="Dynamic" type="integer"  runat="server">
不能为空</asp:RequiredFieldValidator>
 </tr>
<tr>
  <td  height=25>图片链接</td>
  <td><asp:TextBox id="Zdy_link" runat="server"  TextMode="multiLine"  style="width:95%;height:100px"/><br>多个链接请用"|"分开,
 </tr>
<tr>
  <td  height=25>图片标题</td>
  <td><asp:TextBox id="Zdy_title" runat="server"  TextMode="multiLine"  style="width:95%;height:100px"/> <br>多个链接请用"|"分开,
