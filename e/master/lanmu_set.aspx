...
<tr>
  <td>自定义样式路径<br></td>
  <td><asp:textBox TextMode="singleLine" id="tb_csspath" runat="server" maxlength="150" style="width:300px" /> 如：/e/templates/01/diy.css，留空则继承网站参数设置的样式
  </td>
</tr>
...
<tr style="display:<%=LanmuType=="home"?"none":""%>">
    ...
    <input type="radio"  name="location_style" value="1" <%=Location_Style=="1"?"checked":""%>>不显示栏目名称（首页 &gt; 子栏目名）
  </td>
 </tr>
