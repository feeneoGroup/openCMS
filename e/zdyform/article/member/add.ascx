...
<%Start();%>
<tr id='tr_article_title'><td class='tdhead'>标题<span style='color:#ff0000'>*</span></td><td><input type=text name='title' id='title' value="<%if(post=="add"){Response.Write("");}else{Response.Write(r("title"));}%>" style='width:400px'   maxlength='250' ><span id="title_tip"></span></td></tr>
<tr id='tr_article_pa_style'><td class='tdhead'>标题样式</td><td><input type=text name='pa_style' id='pa_style' value="<%if(post=="add"){Response.Write("");}else{Response.Write(r("pa_style"));}%>"  maxlength='250' ><span id="pa_style_tip"></span></td></tr>
