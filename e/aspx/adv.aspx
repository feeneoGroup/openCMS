...
var LeftAdv="<div id=\"adv_<%=Id%>_left\" style='left:5px;position:absolute;top:180px;z-index:100'><%=Left_content%></div>"
var RightAdv="<div id=\"adv_<%=Id%>_right\" style='right:5px;position:absolute;top:180px;z-index:100'><%=Right_content%></div>"
if(Adv_range_<%=Id%>!="0")
   {
